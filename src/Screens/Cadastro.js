    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#e8ecf4" }}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          />
          <Text style={styles.title}>Crie sua conta no Minhas Vacinas</Text>
        ...
        <View style={styles.form}>
          <View style={styles.input}>
            <Text style={styles.inputLabel}>Crie sua senha</Text>
            <TextInput
              secureTextEntry
              placeholder="********"
              placeholderTextColor="#6b7280"
        ...
        <View style={styles.form}>
          <View style={styles.input}>
            ...
            <TextInput
              ...
              style={styles.inputControl}
              value={form.password}
              onChangeText={(Confpassword) => setForm({ ...form, Confpassword })}
            />
          </View>
        </View>
        ...
        >
          <Text style={styles.formFooter}>
            Já tem uma conta?{" "}
            <Text style={{ textDecorationLine: "underline" }}>Entre</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
